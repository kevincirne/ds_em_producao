...
class Rossmann (object):
       def __init__(self):
              self.home_path = '/home/laflamebr/Documentos/repos/ds_em_producao/'
       ...
       def data_preparation (self, df5):
              ...
              df5['competition_since_month'] = self.competition_since_month_scaler.transform(df5[['competition_since_month']].values)
              ...
              cols_selected = ['store', 'promo','store_type','assortment','competition_distance','competition_open_since_month','competition_open_since_year',
                               'promo2','promo2_since_week','promo2_since_year','competition_since_month','promo_time_week','day_of_week_sin','day_of_week_cos',
